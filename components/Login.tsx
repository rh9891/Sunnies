...
export default function Login({className}: LoginProps) {
    return (
        <div className={'flex flex-col flex-1 justify-center items-center gap-4 ' + className}>
            <h3 className={'text-4xl sm:text-5xl md:text-6xl ' + atmaSans.className}>Log In to Your Account</h3>
            ...
            <div className='max-w-[400px] w-full mx-auto flex flex-col gap-4'>
                ...
                <p className={nunitoSans.className + ' text-center'}>Don&#39;t have an account? <span
                    className='text-gradient'>Sign Up</span></p>
            </div>
        </div>
    )
}